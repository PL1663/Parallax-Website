...
// Adjust bubble speed for mobile view
if (screen.width < 400) {
...
window.addEventListener('scroll', function () {
    ...
    fish1.style.transform = 'translateY(' + value * -0.15 + 'px)';
    fish2.style.transform = 'translateY(' + value * -0.25 + 'px)';
    fish3.style.transform = 'translateY(' + value * -0.35 + 'px)';
    fish4.style.transform = 'translateY(' + value * -0.45 + 'px)';
})
